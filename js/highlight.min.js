...
className:"meta",begin:"#",end:"$"}]})})();hljs.registerLanguage("glsl",e)})();/*! `java` grammar compiled for Highlight.js 11.6.0 */
(()=>{var e=(()=>{"use strict"
...
begin:/[-+*/=%^~]|&&?|\|\|?|!=?|<(?:=>?|<|>)?|>[>=]?/,relevance:0}]}}})()
;hljs.registerLanguage("sql",e)})();/*! `prolog` grammar compiled for Highlight.js 11.6.0 */
...
;hljs.registerLanguage("matlab",e)})();/*! `gradle` grammar compiled for Highlight.js 11.6.0 */
